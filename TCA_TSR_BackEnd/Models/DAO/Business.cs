            ...
            try
            {
                switch (_DbConnection)
                {
                    case DBConn.ServidorLocal:
                        ...
                        _conn = new SqlConnection("Data Source=CHERNANDEZ-WK02\\MSSQLSERVER1;Initial Catalog=Transport_Service_Requests;Persist Security Info=True;User ID=sa;Password=Trancasa.01$");
                        break;
                    case DBConn.Server1:
